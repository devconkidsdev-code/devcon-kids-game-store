...
3. Highlight authentic tribal heritage (the 7 tribes: Talaandig, Higaonon, Bukidnon, Umayamnon, Matigsalug, Manobo, Tigwahanon), culinary treats (Binaki, Monk's blend coffee, Del Monte pineapples, Bukidnon steak, CMU dairy), and practical high-altitude mountain tips (14-16\xB0C cool night temperatures in Dahilayan & Kitanglad).
...
`;
      ...
      return res.json({
        ...
        note: openRouterKey ? void 0 : "Generated via Bukidnon Native AI Engine. Connect your OpenRouter API Key for live LLM customization."
      });
    } catch (error) {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`\u{1F332} Bukidnon Tourism Server running on http://0.0.0.0:${PORT}`);
  });
}
function generateIntelligentBukidnonItinerary(params) {
    ...
    daysPlan.push({
      ...
      stops: [
        ...
        },
        {
          ...
          travelTip: "Bring a light windbreaker jacket; mountain breezes drop to 18\xB0C by mid-afternoon.",
      ...
      daysPlan.push({
        ...
        stops: [
          ...
          },
          {
            ...
            travelTip: "Highest mountain pass along Bukidnon-Davao highway with breezy 17\xB0C sunset winds.",
      ...
      daysPlan.push({
        ...
        stops: [
          ...
          },
          {
            ...
            municipality: "Manolo Fortich",
            timeSlot: "Sunset/Night",
            activityDescription: "Conclude with thrilling ziplines, alpine coasters, and cozy campfire dining in the cool 14\xB0C pine woods.",
  ...
  return {
    ...
    packingAdvice: [
      "Thermal jacket or windbreaker (temperatures drop to 14\u201316\xB0C in Dahilayan & Kitanglad at night)",
    ...
    weatherAdvisory: "Highland Subtropical: Crisp mornings (18\xB0C), pleasant sunny midday (26\xB0C), and chilly pine breezes at night (14\xB0C).",
